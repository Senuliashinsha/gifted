...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~uzJUwaLR#9OfOButwkKoAMActRu9WqgMm09e5bWyhEGaHs6jYFpE", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...

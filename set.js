...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~fuQhQaqY#abvaDbyE_iZuP_9_VkJlpUt9hKbE1Myztba8v725Ye4", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
